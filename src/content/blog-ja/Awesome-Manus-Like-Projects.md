...
- [Manus に似た優れたプロジェクト](#awesome-manus-like-projects)
  - [技術スタック](#technical-stack)
  - [目次](#contents)
  - [オープンソース複製品](#opensource-copy)
    - [OpenManus](#openmanus)
    - [OWL](#owl)
    - [LangManus](#langmanus)
  ...
  - [モデルサービングフレームワーク](#model-serving-frameworks)
  - [エージェント開発キット](#agent-development-kits)
  - [モデル評価とベンチマーク](#model-evaluation--benchmarking)
  - [モデルトレーニングとファインチューニング](#model-training--fine-tuning)
  - [専門的エージェントアプリケーション](#specialized-agent-applications)
  - [その他](#misc)
  - [貢献](#contributing)
  - [ライセンス](#license)
...
**リポジトリ:** [OpenManus](https://github.com/OpenManus/OpenManus)
...
**リポジトリ:** [OWL](https://github.com/SalesforceAIResearch/OWL)
...
**リポジトリ:** [LangManus](https://github.com/LangManus/LangManus)
...
本プロジェクトは MIT ライセンスを採用しています - 詳細は [LICENSE](LICENSE) ファイルを参照してください。
