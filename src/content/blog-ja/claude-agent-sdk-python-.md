...
author: "Remy"
tags: ["claude コード", "vibe coding", "Python"]
lang: "ja"
---
...
**SDK 实现**:
- **SDK MCP サーバー** (进程内): 使用 `create_sdk_mcp_server()` 创建
- **External MCP サーバー** (外部进程): 通过 stdio/SSE/HTTP 通信
...
- **Claude コード 文档**: https://docs.anthropic.com/en/docs/claude-code/
...
- **Claude コード CLI**: https://github.com/anthropics/claude-code
- **MCP (Model 文脈 プロトコル)**: https://modelcontextprotocol.io/
