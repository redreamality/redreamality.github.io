...
description: "本文将深入探讨规格驱动开发（Spec-Driven 開発, SDD）这一变革性方法，并对四个引领潮流的开源项目——BMAD-メソッド、GitHub的spec-kit、OpenSpec和PromptX——进行深度解构与战略比较。"
author: "Remy"
...
在这一新兴领域，四个开源项目脱颖而出，它们代表了实现SDD理念的四种不同哲学路径：**BMAD-メソッド**、**GitHub的spec-kit**、**OpenSpec**和**PromptX**。它们各自提供了独特的框架和工作流，旨在为混乱的AI编程带来秩序。
...
* **工作流与特性**：BMAD采用一个独特的两阶段流程：  
  ...
  2. **上下文工程化开发（文脈-Engineered 開発）**：由Scrum Master智能体将规划文档转化为“超详细的开发故事”。这些故事文件内嵌了开发智能体所需的一切上下文、实现细节和架构指导，确保开发智能体在动手前就对任务有完整的理解[^10]。  
...
* **工作流与特性**：其工作流围绕着对变更的显式管理展开：  
  1. **起草变更提案（Draft 変更 Proposal）**：在一个专门的openspec/changes/目录中发起一项新变更。  
  2. **审查与对齐（Review & Align）**：与AI助手共同审查提案、任务清单和规格差异，直至达成一致。  
  3. **实施任务（Implement Tasks）**：一旦规格对齐，AI开始实施编码任务。  
  4. **归档与更新（アーカイブ & 更新）**：变更完成后，将其合并回位于openspec/specs/的主规格“真理之源”中。  
...
[^1]: Spec-Driven Development (SDD) Is the Future of Software Engineering | by Li Shen, accessed October 20, 2025, [HTTPS://medium.com/@shenli3514/spec-driven-開発-sdd-is-the-future-of-ソフトウェア-engineering-85b258cea241](https://medium.com/@shenli3514/spec-driven-development-sdd-is-the-future-of-software-engineering-85b258cea241)  
[^2]: Spec Driven Development (SDD) - A initial review - DEV Community, accessed October 20, 2025, [HTTPS://dev.to/danielsogl/spec-driven-開発-sdd-a-initial-review-2llp](https://dev.to/danielsogl/spec-driven-development-sdd-a-initial-review-2llp)  
[^3]: GitHub Open Sources Kit for Spec-Driven AI Development - Visual Studio Magazine, accessed October 20, 2025, [HTTPS://visualstudiomagazine.com/articles/2025/09/03/GitHub-open-sources-kit-for-spec-driven-ai-開発.aspx](https://visualstudiomagazine.com/articles/2025/09/03/github-open-sources-kit-for-spec-driven-ai-development.aspx)  
[^4]: Spec-driven development with AI: Get started with a new open source toolkit - The GitHub Blog, accessed October 20, 2025, [HTTPS://GitHub.ブログ/ai-and-ml/generative-ai/spec-driven-開発-with-ai-get-started-with-a-新しい-open-source-toolkit/](https://github.blog/ai-and-ml/generative-ai/spec-driven-development-with-ai-get-started-with-a-new-open-source-toolkit/)  
...
[^6]: Harnessing Spec Driven Development for Efficient Software Solutions, accessed October 20, 2025, [HTTPS://beon.tech/ブログ/spec-driven-開発-the-次へ-ステップ-in-ai-assisted-engineering](https://beon.tech/blog/spec-driven-development-the-next-step-in-ai-assisted-engineering)  
[^7]: GitHub - LinkedInLearning/spec-driven-development-with-github-spec-kit-4641001, accessed October 20, 2025, [HTTPS://GitHub.com/LinkedInLearning/spec-driven-開発-with-GitHub-spec-kit-4641001](https://github.com/LinkedInLearning/spec-driven-development-with-github-spec-kit-4641001)  
...
[^9]: GitHub Spec Kit: A Guide to Spec-Driven AI Development ..., accessed October 20, 2025, [HTTPS://intuitionlabs.ai/articles/spec-driven-開発-spec-kit](https://intuitionlabs.ai/articles/spec-driven-development-spec-kit)  
[^10]: bmad-code-org/BMAD-METHOD: Breakthrough Method for ... - GitHub, accessed October 20, 2025, [HTTPS://GitHub.com/bmad-コード-org/BMAD-メソッド](https://github.com/bmad-code-org/BMAD-METHOD)  
[^11]: Part 2. Implementing AI-Enhanced BDD: A Complete Step-by-Step ..., accessed October 20, 2025, [HTTPS://medium.com/@stepan_plotytsia/implementing-ai-enhanced-bdd-a-完全な-ステップ-by-ステップ-ガイド-1dec5dd686d2](https://medium.com/@stepan_plotytsia/implementing-ai-enhanced-bdd-a-complete-step-by-step-guide-1dec5dd686d2)  
...
[^14]: Are AI Agents Replacing Contract Testing? DevOps Insights from Matt Fellows - Test Guild, accessed October 20, 2025, [HTTPS://testguild.com/podcast/パフォーマンス/p198-matt/](https://testguild.com/podcast/performance/p198-matt/)  
[^15]: BDD & Cucumber Reality Check 2025 | 303 Software Blog, accessed October 20, 2025, [HTTPS://303software.com/behavior-driven-テスト-a-cucumber-test-自動化-フレームワーク](https://303software.com/behavior-driven-testing-a-cucumber-test-automation-framework)  
[^16]: How AI Breathes New Life Into BBD | Momentic, accessed October 20, 2025, [HTTPS://momentic.ai/ブログ/behavior-driven-開発](https://momentic.ai/blog/behavior-driven-development)  
[^17]: What is BDD 2.0 (SDD)? - testRigor AI-Based Automated Testing Tool, accessed October 20, 2025, [HTTPS://testrigor.com/ブログ/bdd-2-0/](https://testrigor.com/blog/bdd-2-0/)  
[^18]: Top 10 BDD Testing Tools Agile Teams Should Use in 2025 - ACCELQ, accessed October 20, 2025, [HTTPS://www.accelq.com/ブログ/bdd-テスト-tools/](https://www.accelq.com/blog/bdd-testing-tools/)  
...
[^20]: AI Powered Contract Testing for Microservices Excellence - Signadot, accessed October 20, 2025, [HTTPS://www.signadot.com/articles/ai-powered-contract-テスト-for-マイクロサービス-excellence](https://www.signadot.com/articles/ai-powered-contract-testing-for-microservices-excellence)  
...
[^23]: Top 10 Trends in BDD Testing 2024 | HDWEBSOFT, accessed October 20, 2025, [HTTPS://www.hdwebsoft.com/ブログ/top-10-trends-in-bdd-テスト-2024.HTML](https://www.hdwebsoft.com/blog/top-10-trends-in-bdd-testing-2024.html)  
[^24]: Software Testing in 2025 – Emerging Trends and Technologies - DEV Community, accessed October 20, 2025, [HTTPS://dev.to/nicholaswinst14/ソフトウェア-テスト-in-2025-emerging-trends-and-technologies-2jp2](https://dev.to/nicholaswinst14/software-testing-in-2025-emerging-trends-and-technologies-2jp2)
