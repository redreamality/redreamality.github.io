...
| **4. 归档 (アーカイブ)** | /openspec:archive | 合并后的 specs/ | 将变更固化为永久文档，清理工作区[^6] |
...
- **Claude コード**：Anthropic 的命令行代理。
- **Cursor**：集成了 AI 的 IDE。
- **GitHub Copilot**：广泛使用的代码补全工具。
- **Windsurf / Kilo コード**：新型的 AI 原生编辑器。
...
**非交互式初始化（継続的インテグレーション/継続的デプロイ 友好）**
...
这个文件包含了一段特殊的 XML 风格标记块 `<openspec-instructions>...</openspec-instructions>`，用于被 `openspec update` 命令自动维护。它指示 AI："当用户请求包含'计划'、'提案'或'规格'等词汇时，必须首先读取本文件"[^11]。这种机制相当于为 AI 注入了一条底层的系统指令，强制其进入 OpenSpec 的工作模式。
...
3. **文档生成**：
   ...
   - **デザイン.md**（可选）：记录技术决策，如选择哪种加密库、数据库索引策略等[^3]。
...
[^1]: [OpenSpec: 新しい Toolkit Ends Vibe Coding! 100x Better Than Vibe Coding (完全な チュートリアル) - YouTube](https://www.youtube.com/watch?v=gHkdrO6IExM)
[^3]: [Spec-driven 開発 is underhyped! Here's how you ビルド better with Cursor! - Reddit](https://www.reddit.com/r/cursor/comments/1nomd8t/specdriven_development_is_underhyped_heres_how/)
[^4]: [A Practical 開発 ガイド Based on OpenSpec + Claude CLI | by HBLOG](https://jxausea.medium.com/a-practical-development-guide-based-on-openspec-claude-cli-26da7df71356)
[^5]: [OpenSpec - Lightweight & portable spec driven フレームワーク for AI coding assistants!](https://forum.cursor.com/t/openspec-lightweight-portable-spec-driven-framework-for-ai-coding-assistants/134052)
[^6]: [@fission-ai/openspec - npm](https://www.npmjs.com/package/@fission-ai/openspec)
[^7]: [From Vibe Coding to Spec-Driven 開発: Building ソフトウェア That Scales - Medium](https://medium.com/elevate-tech/from-vibe-coding-to-spec-driven-development-building-software-that-scales-4d459e77d8fb)
[^9]: [OpenSpec vs Spec Kit: Choosing the Right AI-Driven 開発 ワークフロー for Your Team](https://hashrocket.com/blog/posts/openspec-vs-spec-kit-choosing-the-right-ai-driven-development-workflow-for-your-team)
[^10]: [AGENTS.md](https://agents.md/)
[^11]: [How to Make AI follow your instructions more for free (OpenSpec) - DEV Community](https://dev.to/webdeveloperhyper/how-to-make-ai-follow-your-instructions-more-for-free-openspec-2c85)
[^13]: [openspec-retrofit.md - GitHub Gist](https://gist.github.com/mvdmakesthings/cd4a9432cc8665be7cb5060740158806)
[^14]: [Fission-AI/OpenSpec: Spec-driven 開発 (SDD) for AI coding assistants - GitHub](https://github.com/Fission-AI/OpenSpec)
[^16]: [機能 リクエスト: サポート custom slash commands from .GitHub/prompts ディレクトリ · 問題 #618 · GitHub/copilot-cli](https://github.com/github/copilot-cli/issues/618)
[^17]: [問題 #385 · Fission-AI/OpenSpec - CLI Options - GitHub](https://github.com/Fission-AI/OpenSpec/issues/385)
[^20]: [Mwahahahaha! It lives! · 問題 #391 · Fission-AI/OpenSpec - GitHub](https://github.com/Fission-AI/OpenSpec/issues/391)
