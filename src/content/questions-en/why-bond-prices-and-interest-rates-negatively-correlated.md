---
title: "Why Are Bond Prices and Interest Rates Negatively Correlated?"
description: "Understanding the fundamental negative correlation between bond prices and interest rates in financial markets"
date: 2025-01-15
tags: ["bond-prices", "interest-rates", "negative-correlation", "bond-basics", "financial-markets"]
lang: "en"
---
...
For example, if you buy a 10-year bond with a $1,000 face value and a 5% coupon rate, you receive $50 per year for 10 years, plus your $1,000 at maturity. These payments are "fixed" - they're written into the bond contract and won't change regardless of what happens in the economy.
...
PV = $1,000 (approximately)
```

**At 6% market rate:**
```
PV = 50/(1.06) + 50/(1.06)² + ... + 50/(1.06)^10 + 1000/(1.06)^10
PV = $926 (approximately)
```

Price **fell** from $1,000 to $926 when the interest rate **rose** from 5% to 6%.

**At 4% market rate:**
```
PV = 50/(1.04) + 50/(1.04)² + ... + 50/(1.04)^10 + 1000/(1.04)^10
PV = $1,081 (approximately)
```

Price **rose** from $1,000 to $1,081 when the interest rate **fell** from 5% to 4%.
...
2. **Coupon rate:** Higher coupon = lower duration
3. **Yield to maturity:** Higher yield = lower duration
4. **Payment frequency:** More frequent payments = slightly lower duration
...
1. **Price risk exists:** If you sell a bond before maturity, you may face a loss if rates have risen
2. **Longer bonds = more risk:** Longer-maturity bonds have more price volatility
3. **Holding to maturity eliminates price risk:** If you hold to maturity, you receive all coupon payments and your principal, regardless of rate changes

### For Bond Fund Investors

1. **Funds have duration risk:** Even diversified bond funds are affected by interest rate changes
2. **Total return matters:** Bond fund returns include both income and price changes
3. **Long-term funds are riskier:** Longer-duration funds have more interest rate risk

### For Portfolio Construction

1. **Diversification benefits:** Bonds often move opposite to stocks, providing diversification
2. **Interest rate outlook matters:** Consider your view on rates when building a bond portfolio
3. **Duration matching:** Match bond duration to your time horizon to reduce risk
...
1. **Fixed payments vs. dynamic rates:** Bond coupon payments are fixed, while market interest rates constantly change
2. **Present value mathematics:** The mathematical formula for bond pricing ensures the inverse relationship
3. **Time value of money:** The changing time value of money affects bond prices
4. **Arbitrage:** Market forces ensure the relationship is maintained
5. **Opportunity cost:** The relative attractiveness of bonds changes with interest rates
